package com.javatechie.us.controller;
...
public class UserController {
	...
	@SuppressWarnings("unchecked")
	@GetMapping("/displayOrders/{category}")
	@CircuitBreaker(name = USER_SERVICE,fallbackMethod = "getAllAvailableProducts")
	public List<OrderDTO> displayOrdersByCategory(@PathVariable("category") String category) {
